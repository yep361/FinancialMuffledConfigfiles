    ...
    if request.method == 'POST':
        ...
        if not name:
            ...
            try:
                ...
                reason_text = ""
                if reason == "랜덤":
                    # 랜덤 옵션일 경우 이유를 명시하지 않음 (AI가 자유롭게 선택)
                    pass
                elif reason == "기타" and other_reason:
                ...
                2. {reason_text if reason != "랜덤" else "재미있고 창의적인 로스트를 자유롭게 만들어주세요. 랜덤으로 선택된 특성을 사용하되, '랜덤'이라는 단어는 응답에 포함하지 마세요."}
